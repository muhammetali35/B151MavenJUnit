...
public class C01_ExplicitWait extends TestBase {
    ...
    */
    ...
    public void test01() {
        ...
        //Locate'ini aldığımız helloWorldText webelementini görünür olana kadar explicit wait ile bekleyeceğiz
        ...
        //visibilityOf() metoduyla görünür olana kadar bekler
    ...
    public void test02() {
        ...
        //Hello World! Yazının sitede oldugunu test et
        driver.findElement(By.xpath("(//h4)[2]"));
