...
public class C03_Dropdown {
    ...
    public void test01() {
        ...
        //visibleText olarak seçim yapacağımız bir method oluşturup proğraming languages ddm'den bir seçenek seçelim
        selectVisibleText(diller,"Java");
        bekle(2);

        //İndex olarak seçim yapacağımız bir method oluşturup proğraming languages ddm'den bir seçenek seçelim
        selectIndex(diller,2);
        bekle(2);

        //Value olarak seçim yapacağımız bir method oluşturup proğraming languages ddm'den bir seçenek seçelim
        selectValue(diller,"js");//html kodlarında value değeri js olduğu için öyle yazdık
