...
public class C02_ExcelRead extends TestBase {
    ...
    /*
    EXCEL dosyasında veri okuyabilmemiz için öncelikle pom.xml dosyamıza poi ve poi.ooxml
    dependency'lerini yüklememiz gerekir.
       Sonra üzerinde çalışacağımız excel dosyasını projemize src>test>java>techpro>resources package'ı
       içine koyarız.
